...
// Modified 2026 for dadiOS: bone tint, tighter radius, quieter refraction.

import QtQuick
import org.kde.plasma.plasmoid

// Dual-Kawase liquid glass, tinted bone. Place inside a PlasmoidItem.
//
// Pipeline:
...
Item {
    ...
    property real refractIOR: 1.45
    property real refractScale: 36
    property color tint: "#fafaf7"
    property real tintAlpha: 0.38
    property real chromaStrength: 0.10
    ...
    property real fallbackOpacity: 0.62
    ...
    property color solidColor: "#fafaf7"
